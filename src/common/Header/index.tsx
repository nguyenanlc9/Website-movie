      ...
      >
        ...
        <div className="hidden md:flex flex-row gap-8 items-center text-gray-600 dark:text-gray-300">
          ...
          <button
            ...
            className={cn(
              `text-[14.75px] font-medium transition-all duration-100 hover:scale-110`,
              isNotFoundPage || isActive
                ? `${textColor} dark:hover:text-secColor hover:text-black`
                : `dark:hover:text-secColor text-gray-300`
            )}
        ...
        <button
          ...
          name="user-icon"
          className={cn(
            `flex items-center justify-end mb-[2px] transition-all duration-100 hover:scale-150`,
            isNotFoundPage || isActive
              ? `${textColor} dark:hover:text-secColor hover:text-black`
              : `dark:hover:text-secColor text-gray-200`
          )}
        >
          <span>
            <HiOutlineUserCircle />
